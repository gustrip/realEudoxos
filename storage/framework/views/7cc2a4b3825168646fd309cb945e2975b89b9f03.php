        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('student.register.submit')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('points') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="points" type="number" class="form-control" name="points" value="<?php echo e(old('points')); ?>" required autofocus>
