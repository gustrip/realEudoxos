        ...
        <div class="span_of_4">
            <div class="col-md-3 span1_of_4">
                ...
                <ul class="f_nav">
                    ...
                    <li><a href="<?php echo e(route('best_sellers')); ?> ">Δημοφιλείς Εκδόσεις</a></li>
                    <li><a href="<?php echo e(route('all_books')); ?> ">Βιβλία</a></li>
                    <li><a href="<?php echo e(route('show_cart')); ?> ">Καλάθι</a></li>
            ...
            <div class="col-md-3 span1_of_4">
                <h4>Λογαριασμός</h4>
                <ul class="f_nav">
                    <li><a href="<?php echo e(route('general_login_form')); ?> ">Είσοδος</a></li>
                    <li><a href="<?php echo e(route('general_register_form')); ?> ">Εγγραφή</a></li>
                    <li><a href="<?php echo e(route('show_cart')); ?> ">Καλάθι</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 span1_of_4">
                ...
                <ul class="f_nav">
                    <li><a href="<?php echo e(route('battle')); ?> ">Η Μάχη των Πανεπιστημίων</a></li>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#clearCart').on('click', function(e){
            ...
            $.ajax({
                type: 'post',
                url: '<?php echo e(route('clear_cart')); ?>',
                dataType: 'json',
        ...
        $('.close1').on('click', function(){
            ...
            $.ajax({
                ...
                type: 'post',
                url: '<?php echo e(route('delete_cart_item')); ?>',
                data: {'row_id':row_id},
                dataType:'JSON',
                success: function(data) {
                    if(data.status == true){
