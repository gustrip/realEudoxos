...
|:---------------:|:----------------:|----------------:|----------:|-----:|----------:|
|<?php echo e($order->created_at); ?>|<?php echo e($order->student->name." ".$order->student->lastName); ?>|<?php echo e($order->total_items); ?>|<?php echo e($order->total_price); ?>|<?php echo e($order->points_used); ?>|<?php echo e($order->final_price); ?>|
