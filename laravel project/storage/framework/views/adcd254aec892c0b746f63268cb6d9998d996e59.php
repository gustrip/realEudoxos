...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <!-- //for bootstrap working -->
    <!-- cart -->
    <script src="<?php echo e(URL::to('js/simpleCart.min.js')); ?>"> </script>
    <!-- cart -->
    <link rel="stylesheet" href="<?php echo e(URL::to('css/flexslider.css')); ?>" type="text/css" media="screen" />
</head>
<body>
            ...
            <div class="header-right">
                <div class="cart box_1">
                    <a href="checkout.html">
                        <h3> <span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)<img src="<?php echo e(URL::to('images/bag.png')); ?>" alt=""></h3>
                    </a>
    ...
    <div class="main-content">
        <div class="online-strip">
            ...
            <div class="col-md-4 shipping-grid">
                <div class="shipping">
                    <img src="<?php echo e(URL::to('images/shipping.png')); ?>" alt="" />
                </div>
        ...
        <div class="products-grid">
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p1.jpg')); ?>" alt="" /></a>
                <div class="mask">
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p2.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p3.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p4.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p5.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p6.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p7.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p8.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
                <a class="product_name" href="single.html">perfectly simple</a>
            ...
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="single.html"><img src="<?php echo e(URL::to('images/p9.jpg')); ?>" alt="" /></a>
                <div class="mask">
                    <a href="single.html">Quick View</a>
                </div>
...
<div class="other-products">
    <div class="container">
        ...
        <ul id="flexiselDemo3">
            <li><a href="single.html"><img src="<?php echo e(URL::to('images/l1.jpg')); ?>" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                    <a class="like_name" href="single.html">perfectly simple</a>
                    <p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
                </div>
            </li>
            <li><a href="single.html"><img src="<?php echo e(URL::to('images/l2.jpg')); ?>" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                    <a class="like_name" href="single.html">praising pain</a>
                    <p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
                </div>
            </li>
            <li><a href="single.html"><img src="<?php echo e(URL::to('images/l3.jpg')); ?>" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                    <a class="like_name" href="single.html">Neque porro</a>
                    <p><a class="item_add" href="#"><i></i> <span class=" item_price">$329</span></a></p>
                </div>
            </li>
            <li><a href="single.html"><img src="<?php echo e(URL::to('images/l4.jpg')); ?>" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                    <a class="like_name" href="single.html">equal blame</a>
                    <p><a class="item_add" href="#"><i></i> <span class=" item_price">$499</span></a></p>
                </div>
            </li>
            <li><a href="single.html"><img src="<?php echo e(URL::to('images/l5.jpg')); ?>" class="img-responsive" alt="" /></a>
                <div class="product liked-product simpleCart_shelfItem">
                    <a class="like_name" href="single.html">perfectly simple</a>
        ...
        <script type="text/javascript" src="<?php echo e(URL::to('js/jquery.flexisel.js')); ?>"></script>
    </div>
</div>
